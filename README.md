...
We have the web application utilizes [Flask](https://flask.palletsprojects.com/) framework and [Redis](https://redis.io/) store.
...
* `web` with container name `app` which builds Dockerfile in the root of the project
